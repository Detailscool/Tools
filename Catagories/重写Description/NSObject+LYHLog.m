...
#import "NSObject+LYHLog.h"
#import <UIKit/UIKit.h>
#import <objc/runtime.h>
@implementation NSObject (Log)
+ (void)load {
    // 交换两个方法的实现
    method_exchangeImplementations(class_getInstanceMethod([NSObject class], @selector(description)), class_getInstanceMethod([NSObject class], @selector(lyhDescription)));
}
/**
